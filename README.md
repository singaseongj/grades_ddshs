...
- **과목별 추이 차트**: Chart.js 기반 라인 차트로 공통국어, 수학(공통수학1·2/대수/미적분 평균), 공통영어, 통합사회, 과학(통합과학1·2/융합탐구/정보과학/과학 선택 과목 평균) 성적 추이를 시각화합니다.
...
| 이름 | 학생 이름 (필수) |
| 번호 | 학생 번호 (선택) |
| S1_공통수학1 ~ S1_통합사회1 | 1학기 과목별 점수 (공통수학1, 공통수학2, 통합과학1, 통합과학2, 융합탐구, 정보과학, 공통국어1, 공통영어1, 통합사회1) |
| S2_대수 ~ S2_통합사회2 | 2학기 과목별 점수 (대수, 미적분, 융합탐구, 역학과 에너지, 화학, 생명과학, 지구과학, 공통국어2, 공통영어2, 통합사회2) |
